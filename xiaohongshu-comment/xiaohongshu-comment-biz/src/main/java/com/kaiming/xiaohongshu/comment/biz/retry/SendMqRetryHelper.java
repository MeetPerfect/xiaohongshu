package com.kaiming.xiaohongshu.comment.biz.retry;
...
/**
 * ClassName: SendMqRetryHelper
 * Package: com.kaiming.xiaohongshu.comment.biz.retry
 * Description:
 *
 * @Auther gongkaiming
 * @Create 2025/7/18 19:19
 * @Version 1.0
 */
@Component
@Slf4j
public class SendMqRetryHelper {
     ...
     * @param message
     */
    public void handleRetry(String topic, Message<String> message) {
        // 异步处理
     ...
     */
    @Recover
    public void fallback(Exception e, String topic,  String bodyJson) {
