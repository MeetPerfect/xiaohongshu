...
/**
 * ClassName: UserCollectCountShardingJob
 * Package: com.kaiming.xiaohongshu.data.align.job
 * Description:
 *
 * @Auther gongkaiming
...
@Component
@Slf4j
public class UserCollectCountShardingJob {
    @Resource
    ...
    public void userCollectCountShardingJobHandler() {
        ...
        for (; ; ) {
            // 分批次查询 t_data_align_user_collect_count_temp_日期_分片序号，如一批次查询 1000 条，直到全部查询完成
